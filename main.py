...
driver = None
def init_driver():
    my_driver = webdriver.Chrome(r'/home/dilab/Documents/GitHub/Tistory-Crawler/chromedriver', options = options)
    ...
    for url_packed in urls:
        ...
        if isNumberAddress:
            ...
            for posting in urls_for_each_blog:
                print(posting)
                try:
                    result, _, body = downloader.downloadHTML(driver, hostname, "https://" + posting)
